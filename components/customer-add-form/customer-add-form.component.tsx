...
const TYPES: readonly [CUSTOMER_TYPE.PremiumCustomer, CUSTOMER_TYPE.StandardCustomer] = [CUSTOMER_TYPE.PremiumCustomer, CUSTOMER_TYPE.StandardCustomer] as const;
